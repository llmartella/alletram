...
run_sql.py
----------
Runs all generated SQL files against a DuckDB database, then validates
the inserted rows for data quality issues.
...
def main():
    ...
    DEFAULT_SQL = "/Users/lorimartella/Documents/gmatter/charlotte_pipe/cpf_python_scripts/sql_output"
    # ------------------------------------------------------------

    ap = argparse.ArgumentParser(description="Run generated SQL files into DuckDB")
