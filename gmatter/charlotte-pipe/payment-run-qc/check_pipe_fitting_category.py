...
# --- Save to CSV ---
discrepancies_df.to_csv("/Users/lorimartella/Documents/gmatter/charlotte_pipe/cpf_python_scripts/outputs/pipe_fitting_discrepancies_duckdb.csv", index=False)
