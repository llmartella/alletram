...
COLUMN_ALIASES: Dict[str, List[str]] = {
    "contractor_name":    ["contractor", "contractor name", "rep", "rep name", "sales rep", "agent", "agent name", "name (customer)", "customer name", "customer"],
    "sales_order_number": ["sales order", "sales order number", "order number", "so number", "so#", "order#", "order count", "po number", "po#", "purchase order", "invoice id", "invoice #", "invoice no", "inv id", "inv #", "order no", "order no."],
    "order_date":         ["order date", "date", "ship date", "po date", "inv-date", "inv date", "invoice date", "invoice-date", "transaction date", "order dt"],
    "item_sku":           ["sku", "item sku", "item number", "item no", "part number", "part no", "product code", "alt1", "alt 1", "alternate 1", "alt#1", "alt-1", "product id", "productid", "mfg part #", "mfg part", "mfg #"],
    "item_sku_category":  ["sku category", "item sku category", "category", "product category", "gph level 4"],
    "item_upc":           ["upc", "item upc", "upc code", "barcode", "upc#", "upc (product)"],
    "item_description":   ["description", "item description", "product description", "product name", "item name", "prod description", "prod desc", "name (product)", "product", "item", "product desc"],
    "unit_price":         ["unit price", "price", "unit cost", "cost", "each", "price line", "list price", "sell price"],
    "ship_quantity":      ["ship quantity", "quantity", "qty", "shipped qty", "units shipped", "units", "total quantity", "total qty", "total units", "quantity sold"],
    "extended_price":     ["extended price", "extended", "ext price", "total price", "amount", "total", "totalnet", "total net", "net total", "net amount", "net price", "total amount", "sum price", "grand total", "ext. price", "extprice", "sales", "net billings"],
}
